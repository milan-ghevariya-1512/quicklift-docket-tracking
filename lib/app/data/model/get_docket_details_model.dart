...
class ApiDocket{
  ...
  factory ApiDocket.fromJson(Map<String, dynamic> json) {
    return ApiDocket(
      ...
      destinationLocationCode : json['destination_location_code'] ?? '',
      originLocationText : json['origin_location_text'] ?? '',
      originLocationName : json['origin_location_name'] ?? '',
      originMobileNumber : json['origin_mobile_number'] ?? '',
      originLocationAddress : json['origin_location_address'] ?? '',
      destinationLocationText : json['destination_location_text'] ?? '',
      destinationLocationName : json['destination_location_name'] ?? '',
      destinationMobileNumber : json['destination_mobile_number'] ?? '',
      originPinCodeText : json['origin_pin_code_text'] ?? '',
      destinationPinCodeText : json['destination_pin_code_text'] ?? '',
      originPinCode : json['origin_pin_code'] ?? '',
      destinationPinCode : json['destination_pin_code'] ?? '',
      originCityText : json['origin_city_text'] ?? '',
      destinationCityText : json['destination_city_text'] ?? '',
      companyName : json['company_name'] ?? '',
      companyAddress : json['company_address'] ?? '',
      companyPanNo : json['company_pan_no'] ?? '',
      companyFirstGstNo : json['company_first_gst_no'] ?? '',
      companyTagLine : json['company_tag_line'] ?? '',
      gstPayBy : json['gst_pay_by'] ?? '',
      pvtMarka : json['pvt_marka'] ?? '',
...
class ApiDocketBooking{
  ...
  factory ApiDocketBooking.fromJson(Map<String, dynamic> json) {
    return ApiDocketBooking(
      docketId : json['docket_id'] ?? '',
      paymentTypeCode : json['payment_type_code'] ?? '',
      transportMode : json['transport_mode'] ?? '',
      serviceMode : json['service_mode'] ?? '',
      ftlTypeId : json['ftl_type_id'] ?? '',
      cargoCategoryId : json['cargo_category_id'] ?? '',
      businessTypeId : json['business_type_id'] ?? '',
      pickup_type_code : json['pickup_type_code'] ?? '',
      packaging_type_id : json['packaging_type_id'] ?? '',
      product_type_id : json['product_type_id'] ?? '',
      is_com : json['is_com'] ?? false,
      com_to_collect : json['com_to_collect'] ?? '',
      com_currency_id : json['com_currency_id'] ?? '',
