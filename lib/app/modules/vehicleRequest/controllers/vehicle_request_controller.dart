...
class VehicleRequestController extends GetxController {
  ...
  createVehicleRequest(context) async {
    ...
    var body = {
      ...
      "MaterialTypeId": (selectedMaterialType?.srNo ?? '').isEmpty ? null : selectedMaterialType?.srNo ?? '',
      "PackagingTypeId": (selectedPackagingType?.srNo ?? '').isEmpty ? null : selectedPackagingType?.srNo ?? '',
