  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Obx(() => Text(controller.isType.value == 0 ? "GR Number : ${controller.docketNo.value}" : controller.isType.value == 1 ? "GR Enquiry Details" : "Status",style: AppTextStyle.regularTextStyle.copyWith(color: AppColors.textBlackColor,fontWeight: FontWeight.w600,fontSize: 16))),
        // actions: [
        //   Padding(
        //     padding: EdgeInsets.only(right: Get.width*0.015),
        //     child: IconButton(onPressed: () {}, icon: Image.asset(AppImage.shareIcon,fit: BoxFit.cover,height: Get.height*0.04,width: Get.height*0.04,)),
        //   )
        // ],
      ),
          ...
          children: [
            ...
            if(controller.isType.value == 1)Container(
              ...
              child: HorizontalDataTable(
                ...
                leftHandSideColBackgroundColor: AppColors.backgroundColor,
                rightHandSideColBackgroundColor: AppColors.backgroundColor,
